...
func TestGetBirdsHandler(t *testing.T) {
	...
	/*
		Define the data that we want to return when the mock `GetBirds` method is called
	...
	*/
	...
	// Now, when the handler is called, it should cal our mock store, instead of the actual one
