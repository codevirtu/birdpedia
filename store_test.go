...
func (s *StoreSuite) SetupSuite() {
	/*
		The database connection is openedd in the setup, and
		stored as an instance variables,
...
func (s *StoreSuite) TestCreateBird() {
	...
	// Assert that there must be one entry with the properties of the bird that  we
	// just inserted (since the database was empty before this)
	if count != 1 {
